# Exercise 3-1
# Retrive the actor ID, first name, last name for all actors. 
...
# Exercise 3-2
# Retrive the actor ID, first name, and last name 
# for all actors whose last name equels 'WILLIAMS' or 'DAVIS'.
SELECT last_name, first_name, actor_id
  FROM actor
...
# of the customers who rented a film on July 5, 2005 (use the rental.rental_date column, 
